...
import getFaucetContractAbi from "@contractAbi/GetFaucet.json";
...
const connectWallet = createAsyncThunk(
  ...
  async () => {
    try {
      ...
      const craftTokenAddress = "0x40686A81647D9b18f9399c8b4Ba5FF45f45aB943";
      ...
      const getFaucetContractAddress =
        "0x316986b2F04FA3714f68eFB1e9D03EBD8cA81A8A";
      ...
      const getFaucetContract = new Contract(
        getFaucetContractAddress,
        getFaucetContractAbi,
        signer
      );
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(connectWallet.fulfilled, (state, action) => {
      ...
      state.accountInfo = {
        ...
        dragonCraftTokenStakingContract:
          action.payload.dragonCraftTokenStakingContract,
        ...
        getFaucetContract: action.payload.getFaucetContract,
