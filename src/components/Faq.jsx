...
const Faq = () => {
  const faq = [
    ...
    },
    {
      id: "6",
      question:
        "What happens if I forget to withdraw after the staking period ends?",
      answer:
    ...
    {
      id: "10",
      question: "How to add craft Token in wallet?",
      answer:
        "This is the craft token address : 0x40686A81647D9b18f9399c8b4Ba5FF45f45aB943 . You can add craft Token in your wallet by going to the Settings tab and clicking on Add Token .",
    },
    {
      id: "11",
      question: "How to add dragon craft Token in wallet?",
      answer:
        "This is the dragon craft token address : 0x1bFbcA7dC3C1b847C74433416a91d0Db98fD3198 . You can add dragon craft Token in your wallet by going to the Settings tab and clicking on Add Token .",
    },
  ];
    ...
    <section>
      <div name="faq" className="relative">
        <div className="container relative z-2 py-10">
          <h2 className="text-center pb-8 text-3xl lg:text-4xl font-bold my-10">
